...
import { AddprotipComponent } from './addprotip/addprotip.component';

@Component({
  selector: 'app-protipalerts',
  templateUrl: './protipalerts.component.html',
  styleUrls: ['./protipalerts.component.css']
})
export class ProtipalertsComponent implements OnInit {
  ...
  createAlertConfigDialog(obj: any): void {
    ...
    const dialogRef = this.dialog.open(AddprotipComponent, {
      width: '950px',
      data: obj.data,
    });
