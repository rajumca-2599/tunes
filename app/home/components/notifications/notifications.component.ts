...
export class NotificationsComponent implements OnInit {
  ...
  oneventTypeChange(id, event) {
    
      this.searchObj.eventtype=id
  }
  getNotificationlist() {
...
// console.log(this.notification,"notifications")
  ...
  InsertNotifications() {
    ...
    // }
    if(this.notification.pushtype=="General"){
    ...
    this.comm.postData('campaign/savecampagin', requesrParams).subscribe((response: any) => {
      ...
      if (response.code == "500" && response.status == "Internal Error") {
        ...
        if (response && response.data != null) {
          ...
          if(response.data.message!="Title Already Exist."){
             this.ResetAddView();
          this.getNotificationlist();
          }
...
if(this.notification.pushtype=="General"){
  this.notification.eventtpye=""
    ...
    let requesrParams = {
      ...
      "eventtpye":this.notification.eventtpye
